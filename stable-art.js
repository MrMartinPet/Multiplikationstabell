...
let base,atlas,saddleSet,ready,serial=0;
...
function init(){return ready||(ready=Promise.all([load('stable-base-corrected.webp'),load('equipment-atlas.webp'),load('saddle-set.webp')]).then(([b,a,s])=>{base=b;atlas=a;saddleSet=s}))}
