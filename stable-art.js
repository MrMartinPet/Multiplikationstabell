...
const gear={
 pad:{light:192,pieces:[{poly:[[891,371],[908,379],[937,398],[971,412],[1007,416],[1045,411],[1081,397],[1117,391],[1131,398],[1143,420],[1155,457],[1167,504],[1171,543],[1167,573],[1159,596],[1145,610],[1119,619],[1038,624],[964,626],[934,620],[915,605],[905,584],[899,550],[897,483],[899,428],[897,395]],box:[886,367,291,263],dest:[891,395,267,241]}]},
...
const crops={top:[290,259,248,330],bottom:[291,549,191,270],shoes:[239,768,241,260],pad:[864,360,316,292],wraps:[700,751,214,208],bridle:[465,140,265,290],accessory:[637,133,125,165]};
...
function init(){return ready||(ready=Promise.all([load('stable-base.webp'),load('equipment-atlas.webp')]).then(([b,a])=>{base=b;atlas=a}))}
...
if(colors.pad&&colors.pad!=='transparent'){ctx.save();ctx.beginPath();path(ctx,[[854,340],[884,375],[912,403],[927,440],[940,482],[926,471],[914,459],[918,484],[901,467],[886,445],[879,416]]);ctx.clip();ctx.drawImage(base,0,0,W,H);ctx.restore()}
